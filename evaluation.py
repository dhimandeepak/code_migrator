...
async def main():
    models = ["gpt-4o-mini", "gpt-3.5-turbo", "ft:gpt-4o-mini-2024-07-18:personal:code-migrator-gptminituning:AIjTWXKk"]
    results = []

    for model in models:
        logging.info(f"Running vibe check for {model}...")
        result = await vibe_check("cm_validation.jsonl", model)
